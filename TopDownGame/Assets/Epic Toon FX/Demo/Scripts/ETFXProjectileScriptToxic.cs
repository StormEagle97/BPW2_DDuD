...
using System.Collections;
    ...
    public class ETFXProjectileScriptToxic : MonoBehaviour
    {
        ...
        {	
            ...
            if (Physics.SphereCast(transform.position, radius, direction, out hit, detectionDistance)) // Checks if collision will happen
            {
                ...
                GameObject impactP2 = Instantiate(impactGrenade, transform.position, Quaternion.FromToRotation(Vector3.up, hit.normal)) as GameObject;
